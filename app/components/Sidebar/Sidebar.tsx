...
const Sidebar = () => {
  ...
  return (
    ...
    >
      <div
        className={`fixed top-0 right-0 h-full glassy_dark text-white grid justify-stretch items-start border-[1px] border-solid !border-neutral-800 min-w-[20vw] transition-all ${
