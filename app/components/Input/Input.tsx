  ...
  return (
    <div className={`grid justify-stretch items-center gap-1`}>
      ...
      <div
        ...
        className={`border-[1px] border-solid border-neutral-700 rounded-lg overflow-hidden bg-neutral-900 flex justify-stretch items-center gap-4 h-10 px-4 [&>svg]:text-neutral-600 [&>svg]:text-xl ${
