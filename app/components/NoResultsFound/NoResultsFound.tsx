...
const NoResultsFound = () => {
  ...
  return (
    <article className="border-[1px] border-solid border-neutral-700 bg-neutral-900 w-[25vw] h-fit grid justify-center items-center gap-4 p-6 pb-12 rounded-xl text-white text-center m-auto">
      <h2>🔍</h2>
